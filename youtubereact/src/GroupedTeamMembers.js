...
function GroupedTeamMembers({ employees, selectedTeam, setTeam }) {
  ...
  function groupTeamMembers() {
    ...
    let teamA = {
      ...
      collapsed: selectedTeam === "TeamA" ? flase : true,
    }teams.push(teamA);
    ...
    let teamB = {
      ...
      collapsed: selectedTeam === "TeamB" ? flase : true,
    }teams.push(teamB);
    ...
    let teamC = {
      ...
      collapsed: selectedTeam === "TeamC" ? flase : true,
    }teams.push(teamC);
    ...
    let teamD = {
      ...
      collapsed: selectedTeam === "TeamD" ? flase : true,
    }teams.push(teamD);
      ...
      {groupedEmployees.map((item) => {
        return (
          ...
          style={{cursor:'pointer'}}>
            ...
            onclick={handleTeamClick}>Team Name: {item.team}</h4>
            <div id={'colapse_' + item.team}
